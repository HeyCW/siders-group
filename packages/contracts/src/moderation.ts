...
export const COMMENT_QUEUE_STATUS_FILTERS = ['visible', 'removed', 'all', 'reported'] as const;
...
export const MODERATION_COMMENT_STATUSES = ['visible', 'removed'] as const;
...
export const COMMENT_REPORT_REASONS = ['spam', 'harassment', 'off_topic', 'other'] as const;
...
export const READER_QUEUE_STATUS_FILTERS = ['active', 'banned', 'all'] as const;
