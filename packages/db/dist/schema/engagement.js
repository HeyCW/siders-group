...
export const COMMENT_STATUS_VALUES = ['visible', 'removed'];
/**
 ...
 */
export const articleViewsDaily = mysqlTable('article_views_daily', {
    articleId: char('article_id', { length: 36 })
        .notNull()
        .references(() => articles.id, { onDelete: 'cascade' }),
 ...
 */
export const viewSeen = mysqlTable('view_seen', {
    articleId: char('article_id', { length: 36 })
        .notNull()
        .references(() => articles.id, { onDelete: 'cascade' }),
