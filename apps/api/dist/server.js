...
import { commentModerationRoutes, commentReportRoutes, readerModerationRoutes, } from './modules/moderation/moderation.routes.js';
...
if (isMainModule) {
    ...
    scheduler.registerJob('* * * * *', createScheduledPublishJob(createArticleRepository(getDatabase(env)), env, logger));
    app.listen(env.PORT, () => {
