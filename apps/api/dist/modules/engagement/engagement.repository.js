...
import { articles, comments, likes, newId, readers } from '@siders/db';
...
export function createEngagementRepository(db) {
    return {
        ...
        async createComment(articleId, readerId, body) {
            ...
            const [row] = await db
                ...
                .limit(1);
            if (!row)
                throw new Error('comment missing immediately after insert');
            return row;
        },
