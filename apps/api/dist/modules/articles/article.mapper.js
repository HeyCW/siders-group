...
export function toPublicCard(env, article) {
 ...
 * is served publicly").
 */
export function toPublicDetail(env, article) {
    return {
...
export function toAdminResponse(env, article) {
    return {
        id: article.id,
        title: article.title,
        slug: article.slug,
 ...
 */
export function toPreviewResponse(env, article) {
    return {
        id: article.id,
        slug: article.slug,
        title: article.title,
