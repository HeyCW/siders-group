...
import { assertVerifiedIdentity, createAuthorizationRequest, exchangeAuthorizationCode, verifyGoogleIdToken, } from '../../lib/google.js';
import { decodeOAuthState, encodeOAuthState, OAUTH_STATE_COOKIE, OAUTH_STATE_TTL_MS, } from '../../lib/oauthState.js';
...
export function googleAuthRoutes(db, env) {
    const router = Router();
    ...
    router.get('/google/callback', requirePublic(), googleCallbackRateLimiter(), async (req, res, next) => {
        try {
