 ...
 */
function moderationDependencies(db) {
...
export function commentModerationRoutes(db) {
    const router = Router();
...
export function readerModerationRoutes(db) {
    const router = Router();
    const controller = moderationDependencies(db);
 ...
 */
export function commentReportRoutes(db) {
    const router = Router();
    const controller = moderationDependencies(db);
