 ...
 */
export async function replaceOrdering(config) {
    const { db, ids, referencedTable, orderingTable, deleteAll, insertOrdered, selectJoined, onInvalidReference } = config;
    try {
