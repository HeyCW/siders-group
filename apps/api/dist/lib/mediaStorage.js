...
export async function ensureMediaStorageDir(env) {
 ...
 */
export async function storeUpload(env, input) {
...
export function publicUrlFor(env, storagePath) {
...
export async function deleteStoredFile(env, storagePath) {
    try {
