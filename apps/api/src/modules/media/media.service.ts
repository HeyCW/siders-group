...
import { deleteStoredFile, storeUpload, type MediaStorageEnv } from '../../lib/mediaStorage.js';
...
export interface MediaService {
  upload(input: UploadMediaInput): Promise<MediaRow>;
  get(id: string): Promise<MediaRow>;
