...
function requireReporterId(req: Request): string {
...
export function createModerationController(service: ModerationService) {
  return {
    async listCommentQueue(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
    ...
    async dismissCommentReports(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
        const id = requireUuidParam(req, 'id');
    ...
    async listReaders(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
    ...
    async moderateReader(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
        const id = requireUuidParam(req, 'id');
