import type { ArticleAdminResponse, ArticlePublicCard, ArticlePublicDetail, CategoryResponse, TagResponse } from '@siders/contracts';
...
function toTaxonomyResponse(refs: TaxonomyRef[]): (CategoryResponse | TagResponse)[] {
