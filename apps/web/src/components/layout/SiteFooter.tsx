...
/** Anak usaha entries are fetched once by `SiteLayout` (rendered on every route) and passed down
 *  as a prop, rather than by this component itself (design.md - "Public data folded into the
 *  existing GET /anak-usaha endpoint"). */
