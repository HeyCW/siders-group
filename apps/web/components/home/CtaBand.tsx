...
export function CtaBand() {
  return (
    <div className="pt-[clamp(40px,6vw,80px)]">
      <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] items-center gap-[clamp(20px,3vw,32px)] border-y-[3px] border-ink py-[clamp(28px,4vw,48px)]">
        ...
        <div className="flex flex-wrap justify-self-start gap-3">
          <Link
            href="/contact"
            className="border-b-2 border-ink pb-[3px] font-sans text-[11px] font-bold uppercase tracking-widest hover:bg-signal"
          >
            Hubungi redaksi →
          </Link>
          <Link
