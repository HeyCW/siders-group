...
/** The create form has one "Choose file" picker — video only, no photo field. */
function createFormVideoPicker(): HTMLElement {
...
describe('GuidePicksPage — new guide pick form', () => {
  ...
  it('keeps "Add guide pick" disabled until city, place, description, and a video are all present', async () => {
    await renderPage();
  ...
  it('submits city, place, description, and videoMediaId on create, with no photo field', async () => {
    await renderPage();
